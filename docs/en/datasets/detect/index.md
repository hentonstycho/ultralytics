...
- [CrowdHuman](crowdhuman.md): A benchmark dataset for detecting humans in crowd scenarios with 470K+ annotated instances from the train and validation subsets, featuring an average of 23 persons per image with various occlusions.
