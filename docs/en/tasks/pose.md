...
!!! example
    ...
    === "Python"
        ...
        metrics.box.image_metrics  # per-image precision and recall dictionary for box
        metrics.pose.map  # map50-95(P)
        metrics.pose.map50  # map50(P)
        metrics.pose.map75  # map75(P)
        metrics.pose.maps  # a list containing mAP50-95(P) for each category
        metrics.pose.image_metrics  # per-image precision and recall dictionary for pose
        ```
